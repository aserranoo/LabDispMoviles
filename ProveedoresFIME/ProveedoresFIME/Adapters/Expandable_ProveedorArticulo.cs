...
namespace ProveedoresFIME.Adapters {
    public class Expandable_ProveedorArticulo : BaseExpandableListAdapter {
        private Activity _context;
        private List<string> _listDataHeader; // header titles
                                              // child data in format of header title, child title
        private Dictionary<string, List<string>> _listDataChild;

        public Expandable_ProveedorArticulo(Activity context, List<string> listDataHeader, Dictionary<String, List<string>> listChildData) {
            _context=context;
            _listDataHeader=listDataHeader;
            _listDataChild=listChildData;
        }
        public void AddChild(int groupPosition, string element) {
        ...
        public override View GetChildView(int groupPosition, int childPosition, bool isLastChild, View convertView, ViewGroup parent) {
            ...
            if (convertView==null) {
                convertView=_context.LayoutInflater.Inflate(Resource.Layout.listItem_ProveedorArticulo, null);
            }
        ...
        public override View GetGroupView(int groupPosition, bool isExpanded, View convertView, ViewGroup parent) {
            ...
            convertView=convertView??_context.LayoutInflater.Inflate(Resource.Layout.listGroup_ProveedorArticulos, null);
